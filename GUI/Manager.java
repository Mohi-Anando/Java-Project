	...
	public Manager()
	{
		...
		for(int i=0;i<cb.length; i++){
		  ...
		  b2 = new JButton("Approve Orders");
				...
				p2.add(b2);
		  b4 = new JButton("Cancle Orders");

				b4.setFont(new Font("Comic Sans MS",Font.BOLD,15));

				b4.setForeground(Color.blue);

				b4.setBounds(400,460,200,35);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==b2){
				...
				try{   
						   ...
						   FileWriter fw2=new FileWriter("approvedOrder.txt");
				...
				String newOrder="",approvedOrders="", oldApprovedOrders="";
				try {
										  File myObj = new File("cancledOrder.txt");
										  Scanner myReader = new Scanner(myObj);
										  while (myReader.hasNextLine()) {
											String temp = myReader.nextLine();
											oldApprovedOrders = oldApprovedOrders + temp + "\n";
				...
				try{   
						   ...
						   FileWriter fw=new FileWriter("order.txt");
						   FileWriter fw2=new FileWriter("cancledOrder.txt");
